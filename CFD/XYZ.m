...
directoryLoad='simulation1.phi';
directorySave='output';
% DEFINE WHICH VARIABLES YOU WANT TO PROCESS
variables={'P1' 'V1' 'U1' 'VOR1' 'DUDY' 'DVDX' }; %to let process all the variables write 'all' (pay attention to time required)

% INSERT YES ONLY IF THE CASE USES BODY FITTED MESH
BFC='no'  
% IF THE CASE USES BODY FITTED MESH INSERT THE DIRECTORY OF NON CARTESIAN FILES (THIS IS NOT MANDATORY)
directory_bfc='C:\phoenics\d_priv1\TestCase1'; 
